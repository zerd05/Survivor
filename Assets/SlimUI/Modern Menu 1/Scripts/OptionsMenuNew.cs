...
namespace SlimUI.ModernMenu{
	public class OptionsMenuNew : MonoBehaviour {
        ...
        public GameObject difficultyeasytext;
		...
		public void  Start (){
			...
			if(Screen.fullScreen == true){
				fullscreentext.GetComponent<TMP_Text>().text = "Вкл";
			}
			else if(Screen.fullScreen == false){
				fullscreentext.GetComponent<TMP_Text>().text = "Выкл";
			}

			// check hud value
			if(PlayerPrefs.GetInt("ShowHUD")==0){
			//	showhudtext.GetComponent<TMP_Text>().text = "Выкл";
			}
			else{
			//	showhudtext.GetComponent<TMP_Text>().text = "Вкл";
			}

			// check tool tip value
			if(PlayerPrefs.GetInt("ToolTips")==0){
				//tooltipstext.GetComponent<TMP_Text>().text = "Выкл";
			}
			else{
				//tooltipstext.GetComponent<TMP_Text>().text = "Вкл";
			}
			...
			if(QualitySettings.vSyncCount == 0){
				vsynctext.GetComponent<TMP_Text>().text = "Выкл";
			}
			else if(QualitySettings.vSyncCount == 1){
				vsynctext.GetComponent<TMP_Text>().text = "Вкл";
			}

			// check mouse inverse
			if(PlayerPrefs.GetInt("Inverted")==0){
				invertmousetext.GetComponent<TMP_Text>().text = "Выкл";
			}
			else if(PlayerPrefs.GetInt("Inverted")==1){
				invertmousetext.GetComponent<TMP_Text>().text = "Вкл";
			}

			// check motion blur
			if(PlayerPrefs.GetInt("MotionBlur")==0){
				motionblurtext.GetComponent<TMP_Text>().text = "Выкл";
			}
			else if(PlayerPrefs.GetInt("MotionBlur")==1){
				motionblurtext.GetComponent<TMP_Text>().text = "Вкл";
			}

			// check ambient occlusion
			if(PlayerPrefs.GetInt("AmbientOcclusion")==0){
				ambientocclusiontext.GetComponent<TMP_Text>().text = "Выкл";
			}
			else if(PlayerPrefs.GetInt("AmbientOcclusion")==1){
				ambientocclusiontext.GetComponent<TMP_Text>().text = "Вкл";
			}
		...
		public void MobileSFXMute (){
			if(PlayerPrefs.GetInt("Mobile_MuteSfx")==0){
				...
				mobileSFXtext.GetComponent<TMP_Text>().text = "Вкл";
			}
			else if(PlayerPrefs.GetInt("Mobile_MuteSfx")==1){
				PlayerPrefs.SetInt("Mobile_MuteSfx",0);
				mobileSFXtext.GetComponent<TMP_Text>().text = "Выкл";
			}
		}
		...
		public void MobileMusicMute (){
			if(PlayerPrefs.GetInt("Mobile_MuteMusic")==0){
				...
				mobileMusictext.GetComponent<TMP_Text>().text = "Вкл";
			}
			else if(PlayerPrefs.GetInt("Mobile_MuteMusic")==1){
				PlayerPrefs.SetInt("Mobile_MuteMusic",0);
				mobileMusictext.GetComponent<TMP_Text>().text = "Выкл";
			}
		}
		...
		public void  CameraEffects (){
			if(PlayerPrefs.GetInt("CameraEffects")==0){
				...
				cameraeffectstext.GetComponent<TMP_Text>().text = "Вкл";
			}
			else if(PlayerPrefs.GetInt("CameraEffects")==1){
				PlayerPrefs.SetInt("CameraEffects",0);
				cameraeffectstext.GetComponent<TMP_Text>().text = "Выкл";
			}
		}
